...
/*
 Collections are an opaque type containing a name stored as a 
 pointer to a C-string in allocated member, and a container of 
 members, represented as pointers to Records.
 */
